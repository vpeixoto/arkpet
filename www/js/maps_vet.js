$(document).ready(function(){
		...
		$.ajax({
			...
			success: function(datos){
				...
				for(var i in dataJson){
					...
					var horario = dataJson[i].horario;
					var icontype ="img/ico_veterinario.png";
					var contentString = msg(nome, end, phone, horario);
	...
	function msg(Nome,End,Phone, Horario){
		var nome = Nome;
		var end = End;
		var phone = Phone;
		var horario = Horario;
      ...
      '<p><b>Horário de funcionamento:</p></b><p>' + horario + '</p> ' +
      '</div>'+
      '</div>';
